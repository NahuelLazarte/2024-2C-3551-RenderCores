...
namespace TGC.MonoGame.TP.Modelos
{
    class Tunnel : Modelo
    {   
        private const string Path = "Models/objetos/tunnel"; //poner acá la ruta del modelo 3D

        public Tunnel(ContentManager content, Vector3 position, Matrix rotation, Color color)
